                        ...
                        <table class="table table-bordered table-striped" width="50%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">{!!$reply->answer->answer!!}</th>
                                    <th scope="row">{!!$reply->answer->question->question!!}</th>
                                    <th scope="row">{{$reply->created_at}}</th>
                                    <td>
                                        <div class=" row">
                                            <div class="col">
                                                <form action="{{route('reply.delete', ['id' => $reply->id])}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
